...
//set productNameKana test
	...
	public void testGetCategiryId4()throws Exception{
		CartInfoDTO dto=new CartInfoDTO();
		try{
			int postalMax=Integer.parseInt("2147483648");
	...
	public void testGetImageFilePath11(){
		CartInfoDTO dto=new CartInfoDTO();
		String expected="abc213あいう１２３漢字";
	...
	@Test
	public void testGetSubtotal14()throws Exception{
		CartInfoDTO dto=new CartInfoDTO();
		try{
			int postalMax=Integer.parseInt("2147483648");
...
@Test
public void testGetSubtotal15()throws Exception{
	CartInfoDTO dto=new CartInfoDTO();
	try{
		int postalMin=Integer.parseInt("-2147483648");
...
public void testSetSubtotal14()throws Exception{
	CartInfoDTO dto=new CartInfoDTO();
	try{
		int postalMax=Integer.parseInt("2147483648");
		dto.setSubtotal(postalMax);
...
public void testSetSubtotal15()throws Exception{
	CartInfoDTO dto=new CartInfoDTO();
	try{
		int postalMin=Integer.parseInt("-2147483648");
		dto.setSubtotal(postalMin);
